...
def handle_dialog(request, response, user_storage, database):
    ...
    if request.is_new_session or input_message in ['войти', 'вход', 'log in']:
        output_message = "Здравствуйте, Вас приветствует LMS Task tracker. " \
                         "Чтобы перейти к работе просто напишите мне свой логин и пароль через пробел."
